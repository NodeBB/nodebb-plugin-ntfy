<form role="form" class="ntfy-settings">
	<div class="row mb-4">
		...
		<div class="col-sm-10 col-12">
			<p class="lead">
				...
				<code>meta.settings.get('ntfy', function(err, settings) {...});</code>
			</p>
			<div class="mb-3">
	...
	<div class="row mb-4">
		...
		<div class="col-sm-10 col-12">
			<div class="mb-3" data-type="sorted-list" data-sorted-list="sample-list" data-item-template="admin/plugins/ntfy/partials/sorted-list/item" data-form-template="admin/plugins/ntfy/partials/sorted-list/form">
